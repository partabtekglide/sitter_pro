...
class AppTheme {
  ...
  // Professional service management color palette
  ...
  static const Color successLight = Color(0xFF059669); // Confirmation states
  static const Color warningLight = Color(0xFFD97706); // Pending bookings
  static const Color accentLight = Color(0xFF7C3AED); // Premium elements
  ...
  static const Color dividerLight = Color(0x1A2563EB); // 10% opacity of primary
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    cardTheme: CardThemeData(
      color: cardLight,
      elevation: 1.0, // Minimal elevation for cards
      shadowColor: shadowLight,
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      elevation: 3.0, // Floating element elevation
    ...
    floatingActionButtonTheme: FloatingActionButtonThemeData(
      ...
      elevation: 3.0, // Maximum elevation for floating elements
      shape: RoundedRectangleBorder(
